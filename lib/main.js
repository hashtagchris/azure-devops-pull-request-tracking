...
class PullRequestTracker {
    constructor(orgUrl, project, personalAccessToken, releaseDefinitionId) {
...
(function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(yield tracker.getDeployInfos([494919]));
        console.log();
        console.log(yield tracker.getDeployInfos([510903]));
        console.log();
        console.log(yield tracker.getDeployInfos([513131, 513094]));
        console.log();
    });
})();
